...
namespace BookClubApi.Migrations
{
    ...
    [Migration("20260831221710_AddBookFutureReadOrder")]
    partial class AddBookFutureReadOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookClubApi.Models.Book", b =>
                {
                    ...
                    b.Property<int>("FutureReadOrder")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookClubApi.Models.Message", b =>
                {
                    ...
                    b.HasIndex("BookId", "SentAt");

                    b.HasIndex("ClubId", "SentAt");

                    b.HasIndex("SenderId", "ClientId")
                        .IsUnique()
            ...
            modelBuilder.Entity("BookClubApi.Models.MessageReaction", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookClubApi.Models.UserDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookClubApi.Models.Message", b =>
                {
                    ...
                    b.HasOne("BookClubApi.Models.Message", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("BookClubApi.Models.User", b =>
                {
                    b.OwnsOne("BookClubApi.Models.UserPreferences", "Preferences", b1 =>
                        {
                            b1.Property<Guid>("UserId");

                            b1.Property<bool>("TapToTalk");
